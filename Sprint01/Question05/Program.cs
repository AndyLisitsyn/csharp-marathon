...
namespace Question05
{
    class Program
    {
        ...
        {
            var child = new Child(2020, "Alex", "healthy", "CH0001");
    ...
    public class Child : Person
    {
        ...
        public override string ToString() { return name + " " + childIDNumber; }
    }
    ...
    public class Adult : Person
    {
        ...
        public override string ToString() { return name + " " + passportNumber; }
    }
}
